...
class BillController extends Controller
{
     ...
     *     summary="账单列表",
     *     @OA\Parameter(name="page_size", in="query", description="每页显示几条信息"),
     *     @OA\Parameter(name="page", in="query", description="当前显示第几页"),
     *     @OA\Response(response=200, description="Success", @OA\JsonContent(
     *         @OA\Property(property="code", type="integer", description="返回码"),
     *         @OA\Property(property="message", type="string", description="错误信息"),
     *         @OA\Property(property="data", type="object", description="返回数据",
     ...
     * @OA\get(
     *     tags={"账单管理"},
     *     path="/api/teacher/get_student_bill_status_list",
     *     summary="学生账单支付情况列表",
     *     @OA\Parameter(name="page_size", in="query", description="每页显示几条信息"),
     *     @OA\Parameter(name="page", in="query", description="当前显示第几页"),
     *     @OA\Parameter(name="bill_id", in="query", description="账单id"),
     ...
     *           ),
     *           @OA\Property(property="list", type="array", description="数据列表", @OA\Items(type="object",
     *               @OA\Property(property="bill_id", type="integer", description="账单id"),
     *               @OA\Property(property="student_id", type="integer", description="学生id"),
     *               @OA\Property(property="status", type="integer", description="账单状态"),
     *               @OA\Property(property="status_description", type="string", description="账单状态-中文描述"),
     *               @OA\Property(property="student", type="object", description="课程详情",
     *                  @OA\Property(property="id", type="integer", description="学生id"),
     *                  @OA\Property(property="name", type="string", description="学生姓名"),
     *                  )
     *             ))
     *         ),
     *         @OA\Property(property="timestamp", type="integer", description="服务器响应的时间戳")
     ...
     *
     */
    public function getStudentBillStatusList(Request $request)
    {
        // 接受参数
        $page_size = $request->input("page_size");
        $current_page = $request->input("page");
        $bill_id = $request->input("bill_id");
        try {
            $query = BillStudent::select("bill_id", "student_id", "status")->where("bill_id", $bill_id)->with([
